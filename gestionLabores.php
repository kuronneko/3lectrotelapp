...
require config::$tecnico_url;
                  ...
                  if(empty($adminSesion->buscarAdministrador($_SESSION[config::$session])->getId())){
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
		...
		$.ajax({
		url:"controller/ajaxLaborController.php",
		method:"POST",
	...
	<body>
		<div>
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<br><br><br><br>
					<h1 class="text-center">Módulo gestión de Labores</h1>
					<br>
					<p class="message" id="userState" name="userState"></p>
					<div class="container-fluid bg-1-1-1" style="padding-left: 0px;padding-right: 0px;">
						<button type="button" name="nuevoUsuario" id="nuevoUsuario" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-primary">Registrar nueva Labor</button>
						<div class="row">
							<div class="col-sm-12">
														...
														echo "<table class='table'>";
																	...
																	echo  "<tbody id='myTable'>";
																		foreach ($laborDAO ->listarLabores() as $labor) {
																				...
																				echo  "<tr>";
																							echo   "<td>".$labor->getId()."</td>";
																							echo   "<td>".$labor->getNombre()."</td>";

												                    echo   "<td>"."<div class='btn-group'>"."<a  href='#' name='delete' value='Delete' class='btn btn-primary delete_data' id='".$labor->getId()."'>Eliminar</a>"."</div>"."</td>"; 
																				echo "</tr>";
					...
					<hr>
						<div><span class="contentTextWarning">Advertencia:</span>&nbsp;<span class="contentText">Eliminar una labor podría afectar los resultados de ciertos elementos del sistema (Mas detalles en soporte)</span></div>
					<div id="add_data_Modal" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-1-1-1">
									<h4 class="modal-title">Opciones de labor</h4><i class="close fas fa-times iconstyle" data-dismiss="modal"></i>
								</div>
